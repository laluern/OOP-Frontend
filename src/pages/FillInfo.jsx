  ...
  return (
    <div className="items-center min-h-screen">
      <video autoPlay loop muted playsInline className="absolute right-0 bottom-0 z-[-1]">
        <source src="/src/assets/plane2.mp4" type="video/mp4">
        </source>
      </video>
        <div className="flex flex-col items-center justify-center w-full translate-y-32 ">
          ...
          <div className="rounded-3xl border-solid bg-neutral-50 pe-5 mb-3 w-5/12 border-slate-500 pb-8 px-4 translate-y-12">
